            ...
            <div className="component-topic-form">
                <form onSubmit={this.onSubmitHandler}>
                    <div className="form-field">
                        ...
                        <input type="text" value={this.state.interest} onChange={(e) => this.onChange('interest', e.target.value)} />
                    </div>
                    <div className="form-field">
                        <label>Type</label>
                        <select value={this.state.type} onChange={(e) => this.onChange('type', e.target.value)} >
                            {SEARCH_TYPES.map(op => <option key={op.id} value={op.id} > {op.text}</option>)}
                        </select>
                    </div>
                    <div className="form-field">
                        <button disabled={this.props.creating} type="submit">Agregar</button>
                    </div>
                </form>
